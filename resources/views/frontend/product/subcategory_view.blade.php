        ...
        <div class="container">
            <div class="archive-header">
                <div class="row align-items-center">
                    <div class="col-xl-3">
                        <h5 class="mb-15">{{ $breadcat->subcategory_name }}</h5>
                        <div class="breadcrumb">
                            <a href="{{ url('/') }}" rel="nofollow"><i class="fi-rs-home mr-5"></i>Home</a>
                            <span></span> {{ $breadcat->category->name }} <span></span>
                            {{ $breadcat->subcategory_name }}
                        </div>
                    </div>
                ...
                <div class="sidebar-widget widget-category-2 mb-30">
                    ...
                    <ul>
                        @foreach ($subcategories as $category)
                            ...
                            <li>
                                <a
                                    href="{{ url('product/subcategory/' . $category->id . '/' . $category->subcategory_slug) }}">
                                    <img src="" alt="" />{{ $category->subcategory_name }}</a><span
