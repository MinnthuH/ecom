                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <div class="detail-extralink mb-50">
                                    ...
                                    <div class="product-extra-link2">
                                        ...
                                        <button type="submit" class="button button-add-to-cart"
                                            onclick="addToCartDetail()"><i class="fi-rs-shopping-cart"></i>Add
                                            to cart</button>
                                        ...
                                        <a aria-label="Add
                                                To Wishlist"
                                            class="action-btn hover-up" href="shop-wishlist.html"><i
                                ...
                                @if ($product->vendor_id == null)
                                    <h6>Sold By:<a href="#"></a><span class="text-danger ms-2">Owner</span></a></h6>
                                @else
                                    <h6>Sold By:<a href="#"><span
                                                class="text-danger ms-2">{{ $product['vendor']['name'] }}</span></a></h6>
                                @endif
                                <hr>
                                ...
                                <div class="font-xs">
                                    <ul class="mr-50 float-start">
                                        <li class="mb-5">Brand: <span
                                                class="text-brand ms-1">{{ $product['brand']['name'] }}</span></li>
                                        <li class="mb-5">Category:<span class="text-brand ms-1">
                                                {{ $product['category']['name'] }}</span></li>
                                        <li>SubCategory: <span
                                                class="text-brand ms-1">{{ $product['subcategory']['subcategory_name'] }}</span>
                                        </li>
                                    </ul>
                                ...
                                <div class="tab-pane fade" id="Vendor-info">
                                    <div class="vendor-logo d-flex mb-30">
                                        ...
                                        <div class="vendor-name ml-15">
                                            ...
                                            @endif
                                            <h6>
                                                <a href="vendor-details-2.html"></a>
                                            </h6>
                                            <div class="product-rate-cover text-end">
                                                <div class="product-rate d-inline-block">
                                                    <div class="product-rating" style="width: 90%"></div>
