                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="{{ route('user.password.update') }}" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label>Old Passwrod<span class="required">*</span></label>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label>New Passwrod<span class="required">*</span></label>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label>Comfirm Passwrod<span class="required">*</span></label>
                                                        <input required="" class="form-control"
                                                            name="new_password_comfimation" type="password"
                                                            id="new_password_comfimation"
                                                            placeholder="Comfirm Password" />

                                                        @error('new_password_comfimation')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
