...
@section('admin')
    ...
    <div class="page-content">
        ...
        <div class="page-content">
            ...
            <hr>
            <div class="card">
                <form id="myForm" action="{{ route('update.product.thambnail') }}" method="post"
            ...
            <div class="card">
                <div class="card-body">
                    <table class="table mb-0 table-striped">
                        ...
                        <tbody>
                            <form id="myForm" action="{{ route('update.product.multiimage') }}" method="post"
                                enctype="multipart/form-data">
                                @csrf
                                @foreach ($multiImages as $key => $img)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('product.multiimage.delete', $img->id) }}"
