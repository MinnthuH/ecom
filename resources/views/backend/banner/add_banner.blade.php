...
@section('admin')
@section('title')
    Add Banner | Pencil eCommerce System
@endsection
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#myForm').validate({
            ...
            messages: {
                banner_title: {
                    required: 'Banner Title ဖြည့်ရန်လို့အပ်ပါသည်',
                },
                banner_url: {
                    required: 'Banner URL ဖြည့်ရန်လို့အပ်ပါသည်',
                },
                banner_image: {
                    required: 'Banner Image ဖြည့်ရန်လို့အပ်ပါသည်',
                },
