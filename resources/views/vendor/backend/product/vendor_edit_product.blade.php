...
@section('vendor')
    ...
    <div class="page-content">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="hot_deals" value="1"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="special_offer"
                                                            value="1" type="checkbox" id="flexCheckDefault"
        ...
        <div class="page-content">
            <h6 class="mb-0 text-uppercase">Update Main Image Thambail</h6>
            <hr>
            <div class="card">
                <form id="myForm" action="{{ route('vendor.update.product.thambnail') }}" method="post"
        ...
        {{-- /// End Main Image Thambnazil Update//// --}}
            ...
            <div class="card">
                <div class="card-body">
                    <table class="table mb-0 table-striped">
                        ...
                        <tbody>
                            <form id="myForm" action="{{ route('vendor.update.product.multiimage') }}" method="post"
                                enctype="multipart/form-data">
                                @csrf
                                @foreach ($multiImages as $key => $img)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('vendor.product.multiimage.delete', $img->id) }}"
